...
examen_matematicas = float(input(" examen de Matematicas: "))
tarea1_matematicas = float(input(" tarea #1 de Matematicas: "))
tarea2_matematicas = float(input(" tarea #2 de Matematicas: "))
tarea3_matematicas = float(input(" tarea #3 de Matematicas: "))

examen_fisica = float(input(" examen de Fisica: "))
tarea1_fisica = float(input(" tarea #1 de Fisica: "))
tarea2_fisica = float(input(" tarea #2 de Fisica: "))

examen_quimica = float(input("examen de Quimica: "))
tarea1_quimica = float(input(" tarea #1 de Quimica: "))
tarea2_quimica = float(input(" tarea #2 de Quimica: "))
tarea3_quimica = float(input(" tarea #3 de Quimica: "))
...
print(f"Entonces el promedio de las materias es {promedio_total}")
